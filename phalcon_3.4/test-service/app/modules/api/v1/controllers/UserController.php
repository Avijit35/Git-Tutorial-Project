...
use Service\Modules\Api\V1\Backend\UserBackend as EntityBackend;
use Service\Modules\Api\V1\Representation\UserCreateOutput as EntityCreateOutput;
use Service\Modules\Api\V1\Representation\UserRetrieveOutput as EntityRetrieveOutput;
use Service\Modules\Api\V1\Representation\UserUpdateOutput as EntityUpdateOutput;
use Service\Modules\Api\V1\Representation\UserDeleteOutput as EntityDeleteOutput;
use Service\Modules\Api\V1\Representation\UserRepresentationMapping as EntityRepresentationMapping;
...
class UserController extends \Phalcon\Mvc\Controller
{
  ...
  public function indexAction()
  {
		...
		{	
			$operation = 'CREATE';
			$frontendInputEntitySchemaURI = '/schemas/user.create.input.schema.json';
    ...
    {
      $operation = 'UPDATE';
      $frontendInputEntitySchemaURI = '/schemas/user.update.input.schema.json';
