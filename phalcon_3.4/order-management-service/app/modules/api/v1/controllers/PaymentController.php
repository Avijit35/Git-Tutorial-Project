...
use Service\Modules\Api\V1\Backend\PaymentBackend as EntityBackend;
use Service\Modules\Api\V1\Representation\PaymentCreateOutput as EntityCreateOutput;
use Service\Modules\Api\V1\Representation\PaymentRetrieveOutput as EntityRetrieveOutput;
use Service\Modules\Api\V1\Representation\PaymentUpdateOutput as EntityUpdateOutput;
use Service\Modules\Api\V1\Representation\PaymentDeleteOutput as EntityDeleteOutput;
use Service\Modules\Api\V1\Representation\PaymentRepresentationMapping as EntityRepresentationMapping;
...
class PaymentController extends \Phalcon\Mvc\Controller
{
  ...
  public function indexAction()
  {
		...
		{	
			$operation = 'CREATE';
			$frontendInputEntitySchemaURI = '/schemas/payment.create.input.schema.json';
    ...
    {
      $operation = 'UPDATE';
      $frontendInputEntitySchemaURI = '/schemas/payment.update.input.schema.json';
